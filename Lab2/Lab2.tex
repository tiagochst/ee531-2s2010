...
\begin{figure}[h!]
\begin{centering}
\includegraphics[scale=0.5]{Imagens/3.3.1onda_completa/no1} \caption{Medida da tensão no nó 1 \label{fig:q2-no1}}
\par\end{centering}
\end{figure}
...
\begin{figure}[h!]
\begin{centering}
\includegraphics[scale=0.5]{Imagens/3.3.1onda_completa/no12} \caption{Medida da tensão nos nós 1 e 2 \label{fig:Fig-45}}
\par\end{centering}
%\end{figure}
\begin{figure}[h!]
\begin{centering}
\includegraphics[scale=0.5]{Imagens/3.3.1onda_completa/p1q3} \caption{Medida da tensão diferencial entre os nós 2 e 3 \label{fig:Fig-45}}
\par\end{centering}
\end{figure}
...
\par\end{centering}
\caption{(a) Onda de entrada do circuito. (b)  Medidas da onda de entrada do circuito. \label{fig:ret-circ1}}
\end{figure}
