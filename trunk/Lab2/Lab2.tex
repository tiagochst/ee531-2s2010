...
\section{Amplificador Operacional}
 ...
 Para esta parte inicial do experimento, o gerador de funções é ajustado para produzir um sinal de tensão com sua forma de onda triangular, com amplitude 10$V_{pp}$, com offset de $5V$, frequência de $10kHz$ e simetria de 50\%. 
...
\begin{figure}[h!]
\begin{centering}
\includegraphics[scale=0.5]{Imagens/3.3.4capacitor_paralelo/3cap} \caption{Forma de onda da tensão no capacitor do retificador de pico. \label{fig:cap-ret}}
\par\end{centering}
\end{figure}
