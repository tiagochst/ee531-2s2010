...
\includegraphics[scale=0.35]{Imagens/mag_low.eps}
\par\end{centering}
}\subfloat[Fase]{\begin{centering}
\includegraphics[scale=0.35]{Imagens/fase_low.eps}
\par\end{centering}
}
\par\end{centering}
...
\includegraphics[scale=0.35]{Imagens/mag_h.eps}
\par\end{centering}
}\subfloat[Fase]{\begin{centering}
\includegraphics[scale=0.35]{Imagens/fase_high.eps}
\par\end{centering}
}
\par\end{centering}
...
Contudo, conforme a figura \ref{fig:Fig-45}, a diferença de fase obtida é um pouco maior que $90^{\circ}$. Consequentemente, a senóide resultante possui um valor tensão de pico a pico de 9,12V, que é maior que o esperado. %erro de 0,175%
