...
Em seguida, os mesmos valores da tabela 1 foram medidos, porém usando-se o recurso measure, além de também ser necessário medir o valor médio e o valor RMS (ambos os valores obtidos também com o recurso measure). Tais dados encontram-se na tabela \ref{tab:measure} . 
...
Os valores obtidos através do recurso cursor com os dos obtidos com o do recurso measure são valores bem semelhantes e próximo um do outro, com a diferença de que os dados adquiridos com o cursor são menos precisos do que os do medidos com o mesure.
...
Em seguida, foi aplicado um sinal senoidal de amplitude $10V_{pp}$, um offset de $0V$ e varoiu-se a frequência conforme a tabela \label{tab:measure}. 
